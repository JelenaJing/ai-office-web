...
import type { ResearchIdeaCard } from '../modules/research/types'
...
export async function generatePlot(params: {
  ...
  form.append('use_llm_type_detection', String(params.useLlm ?? false))
  form.append('auto_recommend', String(params.autoRecommend ?? true))
